package com.virtualbookstore.bookstoreapp.config;
...
import com.virtualbookstore.bookstoreapp.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    AuthenticationManager authenticationManager(AuthenticationConfiguration authenticationConfiguration) throws Exception {
	  ...
	  JwtAuthFilter jwtAuthFilter() {
		  ...
		  return new JwtAuthFilter(userDetailsServiceImpl, jwtService);
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    	...
    	return http
    		...
    		.authorizeHttpRequests(req -> req
    			.requestMatchers("/api/books/browse", "/api/auth/**", "/api/books/view/**").permitAll()
