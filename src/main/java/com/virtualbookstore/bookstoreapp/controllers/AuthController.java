...
import com.virtualbookstore.bookstoreapp.DTO.AuthenticationResponseDTO;
import com.virtualbookstore.bookstoreapp.DTO.LoginDTO;
...
public class AuthController {
	...
	public ResponseEntity<User> userRegistraion(
			@RequestBody RegistrationDTO userDto
			) {
	...
	public ResponseEntity<?> userLogin(
		...
		try {
			...
			return new ResponseEntity<>("User login not successful", HttpStatus.UNAUTHORIZED);
		}
